...
function init(){
	...
	if(old)
		old.remove();
	let puzzle = document.querySelector('.boat-puzzle');
	...
	farmer = new Passenger(textures['/resources/river-crossing/bridge/img/farmer.png'],w2,h2,'farmer',0,true);
	
	wolf = new Passenger(textures['/resources/river-crossing/bridge/img/wolf.png'],w2,h2,'wolf',1);
	
	goat = new Passenger(textures['/resources/river-crossing/bridge/img/goat.png'],w2,h2,'goat',2);
	
	cabbage = new Passenger(textures['/resources/river-crossing/bridge/img/cabbage.png'],w2,h2,'cabbage',3);

	boat = new Boat(textures['/resources/river-crossing/bridge/img/boat.png']); 
...
function loadImages(){
	let total = 0;
	imgSrc = ['/resources/river-crossing/bridge/img/farmer.png','/resources/river-crossing/bridge/img/wolf.png','/resources/river-crossing/bridge/img/goat.png','/resources/river-crossing/bridge/img/cabbage.png','/resources/river-crossing/bridge/img/boat.png'];
	textures = {};
	for(name of imgSrc){
